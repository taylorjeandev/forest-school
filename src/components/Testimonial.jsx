      ...
      <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
        <div className="flex flex-col items-center mx-12 lg:mx-0">
          <div className="relative text-center">
            ...
            <p className="px-6 py-1 text-lg italic">
              James is a wealth of knowledge, the kids always have fun and come
        ...
        <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
          <div className="relative text-center">
            ...
            <p className="px-6 py-1 text-lg italic">
              Its incredible to see the difference in the kids when theyve spent
              all their energy and had plenty of fun spending time with other
              kids in nature and the outdoors
            </p>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
